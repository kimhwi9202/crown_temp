...
namespace xLIB.Editor
{
    public static class EditorTools
    {
        ...
        static public float Slider(string label, float in_value, float fmin, float fmax, int label_width = 100)
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(label, GUILayout.Width(label_width));
            float fvalue = EditorGUILayout.Slider(in_value, fmin, fmax);
            EditorGUILayout.EndHorizontal();
            return fvalue;
        }

        static public int InitField(string label, int in_value, int label_width = 100)
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(label, GUILayout.Width(label_width));
            int ivalue = EditorGUILayout.IntField(in_value);
            EditorGUILayout.EndHorizontal();
            return ivalue;
        }

        static public float FloatField(string label, float in_value, int label_width = 100)
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(label, GUILayout.Width(label_width));
            float fvalue = EditorGUILayout.FloatField(in_value);
            EditorGUILayout.EndHorizontal();
            return fvalue;
        }

        static public bool Toggle(string label, bool in_value, int label_width = 100)
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(label, GUILayout.Width(label_width));
            bool bvalue = EditorGUILayout.Toggle(in_value);
            EditorGUILayout.EndHorizontal();
            return bvalue;
        }

        static public System.Enum EnumPopup(string label, System.Enum selected, Color color, bool group=true)
        {
            if(group) EditorGUILayout.BeginHorizontal();
            GUI.backgroundColor = color;
            System.Enum sel = EditorGUILayout.EnumPopup(label, selected);
            GUI.backgroundColor = Color.white;
            if (group) EditorGUILayout.EndHorizontal();
            return sel;
        }
    }
}